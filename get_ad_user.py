...
def execute_command(columns:str="", properties:str="", search_base:str="", ad_filter:str="*", out_format:str="csv"):
    ...
    ad_filter = "*" if ad_filter == "" or ad_filter is None else ad_filter
    ...
    command = f"%SystemRoot%\\system32\\WindowsPowershell\\v1.0\\powershell.exe -command \"Get-AdUser -Filter {ad_filter}{properties}{search_base}{columns}{out_format}\""
